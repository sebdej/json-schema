...
export type Constraint = "integer" | "enum" | "const" | "minLength" | "maxLength" | "pattern" | "minimum" | "exclusiveMinimum" | "maximum" | "exclusiveMaximum" | "multipleOf" | "minProperties" | "maxProperties" | "minItems" | "maxItems";
