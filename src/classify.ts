...
export function classifyArraySchema(schema: ArraySchema, hook: ClassifierHook): SchemaClassification {
...
export function classifyObjectSchema(schema: ObjectSchema, hook: ClassifierHook): SchemaClassification {
...
export function classifyCombinedSchema(schema: CombinedSchema, hook: ClassifierHook): SchemaClassification {
...
function doClassifySchema(schema: ResolvedJsonSchema, hook: ClassifierHook): SchemaClassification {
...
export function classifySchema(schema: ResolvedJsonSchema, hook?: ClassifierHook): SchemaClassification {
